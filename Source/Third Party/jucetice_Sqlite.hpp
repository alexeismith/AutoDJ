...
public:
    ...
    */
    ...
    /**
    */
    const juce::String getErrorText () const;
    ...
    */
    ...
    /**
    */
    const juce::String getColumnName (const int columnIndex);
    ...
    */
    ...
    /**
    */
    const juce::String columnAsText (const int columnIndex);
...
public:
    ...
    */
    const juce::String openDatabaseFile (const juce::File& file);
    ...
    */
    SqliteResultset* executeQuery (const juce::String& sqlText);
    ...
    */
    const juce::StringPairArray getTableSchema (const juce::String& tableName);
